...
namespace HeroicArcade.CC.Core
{
    public sealed class InputController : MonoBehaviour
    {
        ...
        private void Awake()
        {
            ...
            controls.Gameplay.KAMC.started += OnKeyCPressed;
        ...
        private void OnKeyBPressed(InputAction.CallbackContext context)
        {
            ...
            GameObject.Find("Main_Crane").GetComponent<CraneMagnet>().craneLeft();
        }

         
        [HideInInspector] public bool isKeyCPressed;
        private void OnKeyCPressed(InputAction.CallbackContext context)
        {
            Debug.Log("OnKeyCPressed " + context);
            isKeyCPressed = context.ReadValueAsButton();
            GameObject.Find("Main_Crane").GetComponent<CraneMagnet>().craneRight();
        }
